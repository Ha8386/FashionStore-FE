...
export const routes: Routes = [
  ...
  // ---- Admin ----
  {
    ...
    canActivateChild: [AuthGuard, AdminGuard], // bảo vệ luôn các route con
    ...
    children: [
      ...
      { path: 'products/:id/edit',   loadComponent: () => import('./features/admin/products/product-form.component').then(m => m.ProductFormComponent) },
      { path: 'products/:id',        loadComponent: () => import('./features/admin/products/product-detail.component').then(m => m.ProductDetailComponent) },
    ]
  },
